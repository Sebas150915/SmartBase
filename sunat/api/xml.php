...
class GeneradorXML
{
   function CrearXMLBajaRetenciones($emisor, $cabecera, $detalle,$nombrexml)
   {
      $doc = new DOMDocument();
      ...
      <ext:ExtensionContent>
        ...
        <cbc:ID>RR-20240105-6</cbc:ID>
        <cbc:ReferenceDate>2020-02-24</cbc:ReferenceDate>
        <cbc:IssueDate>2020-02-26</cbc:IssueDate>
        <cac:Signature>
          ...
          <cac:SignatoryParty>
            ...
            <cac:PartyName>
              <cbc:Name>NUBEFACT S.A.</cbc:Name>
            </cac:PartyName>
          </cac:SignatoryParty>
          <cac:DigitalSignatureAttachment>
            <cac:ExternalReference>
              <cbc:URI>20600695771</cbc:URI>
            </cac:ExternalReference>
          </cac:DigitalSignatureAttachment>
        </cac:Signature>
        <cac:AccountingSupplierParty>
          <cbc:CustomerAssignedAccountID>20600695771</cbc:CustomerAssignedAccountID>
          <cbc:AdditionalAccountID>6</cbc:AdditionalAccountID>
          <cac:Party>
            <cac:PartyLegalEntity>
              <cbc:RegistrationName>NUBEFACT S.A.</cbc:RegistrationName>
            </cac:PartyLegalEntity>
          </cac:Party>
        </cac:AccountingSupplierParty>
        <sac:VoidedDocumentsLine>
          ...
          <sac:DocumentSerialID>RRR1</sac:DocumentSerialID>
      ...
      $doc->save($nombrexml.'.XML');
         ...
         return 'XML BAJA DE RETENCION CREADO';
   }


   function CrearXMLRetenciones($emisor, $cliente, $cabecera, $detalle,$nombrexml)
   {
