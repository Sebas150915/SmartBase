    ...
    //var_dump($_POST);
       ...
       $connect->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        ...
        foreach($resultado as $serie )
        {
            ...
            <td><input type="text" min="1" class="form-control input-money" name="cantidad[]" id="cantidad[]" value="'.$cantidad.'" onkeyup="modificarSubtotales()" ><input type="hidden" min="1" class="form-control input-money input-sm" name="cantidadu[]" id="cantidadu[]" value="'.$cantidadu.'" required onkeyup="modificarSubtotales()"></td> <input type="hidden" name="precio_compra[]" value="'.$precio_compra.'"> <input type="hidden" name="factor[]" value="'.$factor.'"> ></td>
