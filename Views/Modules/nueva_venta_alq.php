...
$query_nv = "SELECT * FROM tbl_alq_separaciones WHERE id_separacion =$idseparacion";
...
$query_general = "SELECT * FROM tbl_alq_separaciones WHERE id_separacion =$idseparacion";
$resultado_general=$connect->prepare($query_general);
$resultado_general->execute();
            ...
            <div class="col-12">
              ...
              <div class="row">
                      ...
                      <div class="col-lg-2 col-sm-6 col-sm-2">
                        ...
                        <option <?= $row_general['moneda'] ==='PEN' ? "selected='selected'": "" ?> value="PEN">SOLES</option>
                        <option <?= $row_general['moneda'] ==='USD' ? "selected='selected'": "" ?> value="USD">DOLARES</option>
                        </select>
                      </div>
                      <div class="col-lg-2 col-sm-6 col-sm-2">
